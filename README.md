...
### v0.3 — 基础记忆体系（2026-04-12）

三层记忆架构（L0~L3）、关键词词典、混合检索（向量+BM25+图谱+RRF）、知识图谱、WebSocket 通信、MCP Server、Telegram Bot / QQ 导入 / Docker 部署。

### v0.4 — 性能优化与可视化（2026-04-15）

记忆可视化（Memory Viewer）、启动前健康检查、BM25 增量更新、知识图谱增量更新、logger/constants 包迁移修复安装问题。

### v0.5 — 感知工具与多平台（2026-04-19）

感知工具集（硬件监控、文件扫描、天气、网页获取）、Telegram Bot 桥接、智能路径提取。

### v0.6 — 产品化与体验优化（2026-04-26）

EXE 一键分发、首次启动配置向导、配置热更新、数据库列级校验、打包后 DLL 与 WebView2 修复。

### v0.7 — 智能化升级（规划中）

LoRA 微调、D3.js 知识图谱可视化、移动端适配、CUDA 加速。

> 详细变更记录见 [CHANGELOG.md](./CHANGELOG.md) 和 [Releases](https://github.com/entergirl/Ramaria/releases)。
